...
```{r}
# Function to find valid combinations with 2 or more items having Tier == 'Yes'
get_valid_combinations <- function(df, min_tier_yes_count = 2) {
  ...
  # Start the recursive combination generation with an empty data frame and starting depth of 1
